  ...
  return {
    ...
    loadPreviewDialog: function (resourceData) {
      ...
      function showError(msg){
        ...
        msg = "El recurso no puede visualizarse. Probablemente aun no haya sido cargado en la base de datos del portal y el sistema no logró cargarlo automáticamente. Sin embargo puede descargarlo en su formato orginal haciendo click en el link de descarga.";
        return self.el
          .append('<div></div>')
